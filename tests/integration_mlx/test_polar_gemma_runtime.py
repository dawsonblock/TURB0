...
Contract
--------
- Uses a tiny synthetic model by default; if ``TQ_TEST_GEMMA_MODEL`` is set,
  a real Gemma-family model is used instead.
...
def _load_model_and_tokenizer():
    model_id = os.environ.get("TQ_TEST_GEMMA_MODEL", "")
    if model_id:
...
def test_polar_gemma_runtime_path():
